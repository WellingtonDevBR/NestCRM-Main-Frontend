...
const testimonials = [
  {
    quote: "ChurnWatcher has completely transformed how we approach customer retention. We identified at-risk accounts weeks before they would have cancelled, saving over $300K in annual revenue.",
    author: "Sarah Johnson",
    title: "Director of Customer Success, TechCorp",
    rating: 5
  },
  {
    quote: "The AI predictions are incredibly accurate. Within two months of implementing ChurnWatcher, we reduced our churn rate by 32% and improved our customer satisfaction scores.",
    author: "Michael Chen",
      ...
      <div className="container-custom">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-foreground/70">
            Businesses across industries are using ChurnWatcher to predict and prevent customer churn, leading to increased retention and growth.
          </p>
        </div>
        ...
        <div className="mt-20 p-8 md:p-12 glass-card max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg mb-8 text-foreground/70 max-w-2xl mx-auto">
            Join the businesses that are transforming their customer retention strategies with ChurnWatcher's AI-powered platform.
          </p>
