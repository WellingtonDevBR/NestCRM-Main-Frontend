      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-10 mb-12">
          <div className="md:col-span-2">
            <Link
              to="/"
              className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary to-accent mb-4 inline-block"
            >
              NESTCRM
            </Link>
            <p className="text-foreground/70 mb-4 max-w-md">
              AI-powered customer retention platform that helps businesses predict and prevent churn before it happens.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/cookie-policy" className="text-foreground/70 hover:text-primary transition-colors">
                  Cookie Policy
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/gdpr-compliance" className="text-foreground/70 hover:text-primary transition-colors">
                  GDPR Compliance
                </Link>
              </li>
            </ul>
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6">
            ...
            <Link to="/gdpr-compliance" className="text-foreground/60 hover:text-primary transition-colors text-sm">GDPR</Link>
          </div>
        </div>
      </div>
    </footer>
