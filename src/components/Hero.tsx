  ...
  return (
    <section className="relative pt-28 pb-20 md:pt-40 md:pb-28 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        <div className="absolute top-0 right-0 left-0 h-[600px] bg-gradient-to-b from-primary/5 to-transparent"></div>
        ...
        <div className="flex flex-col lg:flex-row items-center">
          ...
          <div className="w-full lg:w-1/2 flex justify-center lg:justify-end">
            <div className="relative">
              ...
              <div className="absolute -top-4 -left-4 -right-4 -bottom-4 bg-gradient-to-br from-primary/20 to-accent/20 rounded-2xl blur-xl -z-10"></div>
